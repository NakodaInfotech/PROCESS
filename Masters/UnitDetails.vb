...
Public Class UnitDetails
    ...
    Sub fillgrid()
        ...
        If frmstring = "UNIT" Then
            ...
            dttable = OBJCMN.search(" Unit_name, Unit_abbr, Unit_id", "", "Unitmaster", " and unit_cmpid = " & CmpId & " and unit_locationid = " & Locationid & " and unit_yearid = " & YearId)
        ...
        ElseIf frmstring = "PACKINGUNIT" Then
            ...
            dttable = OBJCMN.search(" PackingUnit_name, PackingUnit_abbr, PackingUnit_id", "", "PackingUnitmaster", " and Packingunit_cmpid = " & CmpId & " and Packingunit_locationid = " & Locationid & " and Packingunit_yearid = " & YearId)
        ...
        ElseIf frmstring = "TAXMASTER" Then
            ...
            dttable = OBJCMN.search(" tax_name, tax_abbr, tax_id", "", "Taxmaster", " and tax_cmpid = " & CmpId & " and tax_locationid = " & Locationid & " and tax_yearid = " & YearId)
        ...
        ElseIf frmstring = "OCTROIMASTER" Then
            ...
            dttable = OBJCMN.search(" OCTROI_name, octroi_octroi, OCTROI_id", "", "OCTROImaster", " and OCTROI_cmpid = " & CmpId & " and OCTROI_locationid = " & Locationid & " and OCTROI_yearid = " & YearId)
        ...
        ElseIf frmstring = "SUBPACKINGUNIT" Then
            ...
            dttable = OBJCMN.search(" SubPackingUnit_name, SubPackingUnit_abbr, SubPackingUnit_id", "", "SubPackingUnitmaster", " and SubPackingunit_cmpid = " & CmpId & " and SubPackingunit_locationid = " & Locationid & " and SubPackingunit_yearid = " & YearId)
