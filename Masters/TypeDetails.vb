...
Public Class TypeDetails
    ...
    Private Sub TypeDetails_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub TypeDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub fillgrid()
        ...
        dttable = OBJCMN.search(" TYPE_name, TYPE_id", "", "TYPEmaster", " and TYPE_cmpid = " & CmpId & " and TYPE_Locationid = " & Locationid & " and TYPE_Yearid = " & YearId)
    ...
    Sub showform(ByVal editval As Boolean, ByVal name As String, ByVal id As Integer)
        Try
            ...
            Dim objCategorymaster As New TypeMaster
