...
Public Class UnitMaster
    ...
    Private Sub cmbpackingunit_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbpackingunit.GotFocus
        Try
            If cmbpackingunit.Text.Trim = "" Then
                ...
                Dim dt As DataTable
                dt = OBJCMN.search("packingunit_name", "", "PackingUnitMaster", " and PackingUnit_cmpid = " & CmpId & " and PackingUnit_locationid = " & Locationid & " and PackingUnit_yearid = " & YearId)
    ...
    Private Sub txtname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtname.Validating
        Try
            ...
            If (edit = False) Or (edit = True And LCase(Tempname) <> LCase(txtname.Text.Trim)) Then
                If frmString = "UNIT" Then
                    dt = OBJCMN.search("unit_name", "", "unitMaster", " and unit_name = '" & txtname.Text.Trim & "' And Unit_cmpid = " & CmpId)
                    If dt.Rows.Count > 0 Then
                        MsgBox("Unit Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                        e.Cancel = True
                    End If
                ElseIf frmString = "TAXMASTER" Then
                    dt = OBJCMN.search("tax_name", "", "TaxMaster", " and tax_name = '" & txtname.Text.Trim & "' And tax_cmpid = " & CmpId)
                    If dt.Rows.Count > 0 Then
                        MsgBox("Tax Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                        e.Cancel = True
                    End If
                ElseIf frmString = "OCTROIMASTER" Then
                    dt = OBJCMN.search("OCTROI_name", "", "OCTROIMaster", " and OCTROI_name = '" & txtname.Text.Trim & "' And OCTROI_cmpid = " & CmpId)
                    If dt.Rows.Count > 0 Then
                        MsgBox("OCTROI Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                        e.Cancel = True
                    End If
                ElseIf frmString = "PACKINGUNIT" Then
                    dt = OBJCMN.search("packingunit_name", "", "packingunitMaster", " and packingunit_name = '" & txtname.Text.Trim & "' and PackingUnit_cmpid = " & CmpId)
                    If dt.Rows.Count > 0 Then
                        MsgBox("Packing Unit Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                        e.Cancel = True
                    End If
                ElseIf frmString = "SUBPACKINGUNIT" Then
                    dt = OBJCMN.search("subpackingunit_name", "", "subpackingunitMaster", " and subpackingunit_name = '" & txtname.Text.Trim & "' and SubPackingUnit_cmpid = " & CmpId)
                    If dt.Rows.Count > 0 Then
                        MsgBox("Sub Packing Unit Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                        e.Cancel = True
                    End If
                End If
            End If
        ...
        Try
            If txtabbr.Text.Trim <> "" Then
                ...
                If (edit = False) Or (edit = True And LCase(Tempabbr) <> LCase(txtabbr.Text.Trim)) Then
                    If frmString = "UNIT" Then
                        dt = OBJCMN.search("unit_abbr", "", "unitMaster", " and unit_abbr = '" & txtabbr.Text.Trim & "' And Unit_cmpid = " & CmpId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("Unit Abbr Already Exists", MsgBoxStyle.Critical, "PROCESS")
                            e.Cancel = True
                        End If
                    ElseIf frmString = "TAXMASTER" Then
                        dt = OBJCMN.search("tax_abbr", "", "TaxMaster", " and tax_abbr = '" & txtabbr.Text.Trim & "' And tax_cmpid = " & CmpId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("Tax Abbr Already Exists", MsgBoxStyle.Critical, "PROCESS")
                            e.Cancel = True
                        End If
                    ElseIf frmString = "OCTROIMASTER" Then
                        dt = OBJCMN.search("octroi_octroi", "", "OCTROIMaster", " and octroi_octroi = '" & txtabbr.Text.Trim & "' And OCTROI_cmpid = " & CmpId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("OCTROI Abbr Already Exists", MsgBoxStyle.Critical, "PROCESS")
                            e.Cancel = True
                        End If
                    ElseIf frmString = "PACKINGUNIT" Then
                        dt = OBJCMN.search("packingunit_abbr", "", "packingunitMaster", " and packingunit_abbr = '" & txtabbr.Text.Trim & "' and PackingUnit_cmpid = " & CmpId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("Packing Unit Abbr Already Exists", MsgBoxStyle.Critical, "PROCESS")
                            e.Cancel = True
                        End If
                    ElseIf frmString = "SUBPACKINGUNIT" Then
                        dt = OBJCMN.search("subpackingunit_abbr", "", "subpackingunitMaster", " and subpackingunit_abbr = '" & txtabbr.Text.Trim & "' and SubPackingUnit_cmpid = " & CmpId)
                        If dt.Rows.Count > 0 Then
                            MsgBox("Sub Packing Unit Abbr Already Exists", MsgBoxStyle.Critical, "PROCESS")
                            e.Cancel = True
                        End If
                    End If
                End If
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        If txtname.Text.Trim <> "" Then
            ...
            dt = OBJCMN.search("grade_name", "", " dbo.GRADEMASTER RIGHT OUTER JOIN  dbo.SALEORDER_DESC ON dbo.GRADEMASTER.grade_id = dbo.SALEORDER_DESC.so_gradeid ", " and Grade_name = '" & txtname.Text.Trim & "' and grade_cmpid = " & CmpId & " and grade_Locationid = " & Locationid & " and grade_yearid = " & YearId)
            If dt.Rows.Count > 0 Then
                MsgBox("Size Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "PROCESS")
                Exit Sub
            End If
        ...
        If txtname.Text.Trim <> "" Then
            ...
            dt = OBJCMN.search("grade_name", "", "  dbo.GRADEMASTER RIGHT OUTER JOIN  dbo.GRN_ITEMDESC ON dbo.GRADEMASTER.grade_id = dbo.GRN_ITEMDESC.grn_gradeid", " and Grade_name = '" & txtname.Text.Trim & "' and grade_cmpid = " & CmpId & " and grade_Locationid = " & Locationid & " and grade_yearid = " & YearId)
            If dt.Rows.Count > 0 Then
                MsgBox("Grade Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "PROCESS")
                Exit Sub
            End If
        ...
        If txtname.Text.Trim <> "" Then
            ...
            dt = OBJCMN.search("grade_name", "", "  dbo.GRADEMASTER RIGHT OUTER JOIN dbo.PURCHASEORDER_DESC ON dbo.GRADEMASTER.grade_id = dbo.PURCHASEORDER_DESC.po_gradeid ", " and Grade_name = '" & txtname.Text.Trim & "' and grade_cmpid = " & CmpId & " and grade_Locationid = " & Locationid & " and grade_yearid = " & YearId)
            If dt.Rows.Count > 0 Then
                MsgBox("Grade Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "PROCESS")
                Exit Sub
            End If
        ...
        If txtname.Text.Trim <> "" Then
            ...
            dt = OBJCMN.search("grade_name", "", "  dbo.GRADEMASTER RIGHT OUTER JOIN dbo.PURCHASEQUOTATION_DESC ON dbo.GRADEMASTER.grade_id = dbo.PURCHASEQUOTATION_DESC.quotation_gradeid ", " and Grade_name = '" & txtname.Text.Trim & "' and grade_cmpid = " & CmpId & " and grade_Locationid = " & Locationid & " and grade_yearid = " & YearId)
            If dt.Rows.Count > 0 Then
                MsgBox("Grade Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "PROCESS")
                Exit Sub
            End If
        ...
        If txtname.Text.Trim <> "" Then
            ...
            dt = OBJCMN.search("grade_name", "", "   dbo.GRADEMASTER RIGHT OUTER JOIN dbo.PURCHASEREQUEST_GRIDSET ON dbo.GRADEMASTER.grade_id = dbo.PURCHASEREQUEST_GRIDSET.gradeid ", " and Grade_name = '" & txtname.Text.Trim & "' and grade_cmpid = " & CmpId & " and grade_Locationid = " & Locationid & " and grade_yearid = " & YearId)
            If dt.Rows.Count > 0 Then
                MsgBox("Grade Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "PROCESS")
                Exit Sub
            End If
