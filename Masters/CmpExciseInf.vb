...
Public Class CmpExciseInf
    ...
    Private Function errorvalid() As Boolean
        ...
        If TEMPSTATENAME <> "" And TXTGSTIN.Text.Trim <> "" Then
            ...
            Dim DT As DataTable = OBJCMN.search(" ISNULL(cast(state_remark as varchar(5)),'') AS STATECODE ", "", " STATEMASTER", " AND state_name = '" & TEMPSTATENAME & "'")
