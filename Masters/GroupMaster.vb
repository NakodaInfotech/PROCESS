    ...
    Private Sub txtname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtname.Validating
        Try
            ...
            If (edit = False) Or (edit = True And tempGroupname <> txtname.Text.Trim) Then
                ...
                Dim OBJCMN As New ClsCommonMaster
                Dim dt As DataTable
                dt = OBJCMN.search("group_name", "", "GroupMaster", " and group_name = '" & txtname.Text.Trim & "' and group_cmpid = " & CmpId & " and group_locationid = " & Locationid & " and group_yearid = " & YearId)
                If dt.Rows.Count > 0 Then
                    MsgBox("Group Name Already Exists", MsgBoxStyle.Critical, "PROCESS")
                    e.Cancel = True
                End If
            End If
        Catch ex As Exception
