...
Public Class CityDetails
    ...
    Sub fillgrid()
        ...
        If frmstring = "CITYMASTER" Then
            dttable = OBJCMN.search(" city_name, city_id", "", "citymaster", " and city_cmpid = " & CmpId & " and city_locationid = " & Locationid & " and city_yearid = " & YearId)
        ElseIf frmstring = "AREAMASTER" Then
            dttable = OBJCMN.search(" area_name, area_id", "", "AreaMaster", " and area_cmpid = " & CmpId & " and area_locationid = " & Locationid & " and area_yearid = " & YearId)
        ...
        ElseIf frmstring = "STATEMASTER" Then
            dttable = OBJCMN.search(" state_name, state_id", "", "StateMaster", " and state_cmpid = " & CmpId & " and state_locationid = " & Locationid & " and state_yearid = " & YearId)
        ElseIf frmstring = "COUNTRYMASTER" Then
            dttable = OBJCMN.search(" country_name, country_id", "", "Countrymaster", " and country_cmpid = " & CmpId & " and country_locationid = " & Locationid & " and country_yearid = " & YearId)
        ElseIf frmstring = "GODOWNMASTER" Then
            dttable = OBJCMN.search(" GODOWN_name, GODOWN_id", "", "GODOWNmaster", " and GODOWN_yearid = " & YearId)
        End If
