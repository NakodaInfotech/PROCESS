...
Public Class ColorMaster
    ...
    Private Sub CMDSAVE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDSAVE.Click
        Try
            ...
            Dim OBJADD As New ClsColorMaster
        ...
        Try
            ...
            Else
                If (EDIT = False) Or (EDIT = True And LCase(TEMPNAME) <> LCase(TXTNAME.Text.Trim)) Then
                    ...
                    dt = OBJCMN.search(" COLOR_NAME ", "", " COLORMASTER ", " AND COLOR_NAME = '" & TXTNAME.Text.Trim & "' AND  COLOR_YEARID = " & YearId)
    ...
    Private Sub StoreItemMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                ALPARAVAL.Add(TEMPID)
                ALPARAVAL.Add(YearId)
                Dim OBJSELECT As New ClsColorMaster
                OBJSELECT.ALPARAVAL = ALPARAVAL
                Dim dttable As DataTable = OBJSELECT.GETCOLOR()
    ...
    Private Sub CMDDELETE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDDELETE.Click
        Try
            If EDIT = True Then
                ...
                Dim tempmsg As Integer = MsgBox("Delete Color Permanently?", MsgBoxStyle.YesNo, "PROCESS")
                If tempmsg = vbYes Then

                    Dim OBJPORTFOLIO As New ClsColorMaster
                    Dim ALPARAVAL As New ArrayList
