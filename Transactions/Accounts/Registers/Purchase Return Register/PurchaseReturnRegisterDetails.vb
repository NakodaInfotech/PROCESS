...
Public Class PurchaseReturnRegisterDetails
    ...
    Sub fillgrid()
        ...
        Dim objregister As New ClsPurchaseReturnRegister
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            If chkdetails.Checked = False Then
                objreg.frmstring = "PurchaseReturnRegister"
            Else
                objreg.frmstring = "PurchaseReturnRegisterDetails"
            End If
            If chkdate.Checked = True Then
