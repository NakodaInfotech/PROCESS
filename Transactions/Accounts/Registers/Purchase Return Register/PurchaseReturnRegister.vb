...
Public Class PurchaseReturnRegister

    Private Sub PurchaseReturnRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            fillregister(cmbregister, " AND REGISTER_TYPE = 'PURCHASERETURN' AND REGISTER_YEARID = " & YearId)
            fillgrid()
    ...
    Private Sub PurchaseReturnRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub fillgrid()
        Try
            ...
            Dim OBJPURREG As New ClsPurchaseReturnRegister
    ...
    Sub SHOWFORM()
        Try
            Dim objPURdetails As New PurchaseReturnRegisterDetails
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Try
            ...
            objreg.frmstring = "PurchaseReturnRegisterMonthly"
