...
Public Class RegisterDetails
    ...
    Sub fillgrid()
        ...
        gridregister.Columns("PANNO").Visible = False
        gridregister.Columns("TDSFORM").Visible = False
        ...
        ElseIf chkdetails.Checked = True Then
            ...
            gridregister.Columns("PANNO").Visible = True
            gridregister.Columns("TDSFORM").Visible = True
