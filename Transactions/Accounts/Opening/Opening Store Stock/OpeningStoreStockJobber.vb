...
Public Class OpeningStoreStockJobber
    ...
    Private Function CHECKGRID() As Boolean
        ...
        For Each ROW As DataGridViewRow In gridstock.Rows
            If GRIDDOUBLECLICK = False Or (GRIDDOUBLECLICK = True And TEMPROW <> ROW.Index) Then
                If (ROW.Cells(GNAME.Index).Value = CMBNAME.Text.Trim And ROW.Cells(GITEMNAME.Index).Value = CMBITEMNAME.Text.Trim) Then
    ...
    Private Sub OpeningJobberStock_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub FILLGRID()
        Try
            ...
            Dim OBJOPSTOCK As New ClsOpeningStoreStockJobber
            ...
            If dttable.Rows.Count > 0 Then
                ...
                For Each ROW As DataRow In dttable.Rows
                    GRIDSTOCK.Rows.Add(Val(ROW("OPSTOCKNO")), ROW("NAME"), ROW("ITEMNAME"), Val(ROW("QTY")), Val(ROW("OUTQTY")))
    ...
    Private Sub TXTQTY_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTQTY.Validating
        ...
        If CMBNAME.Text.Trim = "" Or CMBITEMNAME.Text.Trim = "" Or Val(TXTQTY.Text.Trim) = 0 Then
        ...
        Dim OBJOPENSTOCK As New ClsOpeningStoreStockJobber
    ...
    Private Sub OpeningJobberStock_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If e.KeyCode = Keys.Delete Then
                If GRIDSTOCK.SelectedCells.Count > 0 Then
                    ...
                    If TEMPMSG = vbYes Then
                        Dim ALPARAVAL As New ArrayList
                        Dim OBJNO As New ClsOpeningStoreStockJobber
