...
Public Class OpeningStockBeamGodown
    ...
    Sub FILLGRID()
        Try
            ...
            Dim OBJOPSTOCK As New ClsOpeningStockBeamGodown
            ...
            If dttable.Rows.Count > 0 Then
                ...
                For Each ROW As DataRow In dttable.Rows
                    GRIDSTOCK.Rows.Add(Val(ROW("OPBEAMSTOCKNO")), ROW("GODOWN"), ROW("BEAM"), ROW("BEAMNO"), Val(ROW("ENDS")), Val(ROW("TAPLINE")), Val(ROW("CUT")), Format(Val(ROW("WT")), "0.000"), Format(Val(ROW("WTCUT")), "0.000"), ROW("REMARKS"), ROW("DONE"))
    ...
    Private Sub TXTREMARKS_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTREMARKS.Validating
        ...
        If CMBOURGODOWN.Text.Trim <> "" And CMBBEAM.Text.Trim <> "" And TXTBEAMNO.Text.Trim <> "" And Val(TXTCUT.Text.Trim) > 0 And Val(TXTWT.Text.Trim) > 0 Then
            ...
            Dim OBJOPENSTOCK As New ClsOpeningStockBeamGodown
            ...
            If e.KeyCode = Keys.Delete Then
                If GRIDSTOCK.SelectedCells.Count > 0 Then
                    ...
                    If TEMPMSG = vbYes Then
                        Dim ALPARAVAL As New ArrayList
                        Dim OBJNO As New ClsOpeningStockBeamGodown
    ...
    Private Sub CMBBEAMFILTER_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMBBEAMFILTER.Validated
        Try
            ...
            If CMBBEAMFILTER.Text.Trim <> "" Then
                ...
                Dim dt As DataTable = objclsCMST.search("ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_NO, 0) AS OPBEAMSTOCKNO, ISNULL(GODOWNMASTER.GODOWN_NAME,'') AS GODOWN, ISNULL(BEAMMASTER.BEAM_NAME, '') AS BEAM, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_BEAMNO, '')AS BEAMNO, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_ENDS, 0) AS ENDS, ISNULL(BEAMMASTER.BEAM_TAPLINE, 0) AS TAPLINE, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_CUT, 0) AS CUT, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_WT, 0) AS WT, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_WTCUT, 0) AS WTCUT, ISNULL(STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_REMARKS, '') AS REMARKS, STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_DONE AS DONE ", " ", " STOCKMASTER_BEAMGODOWN INNER JOIN BEAMMASTER ON STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_BEAMID = BEAMMASTER.BEAM_ID AND STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_YEARID = BEAMMASTER.BEAM_YEARID INNER JOIN GODOWNMASTER ON GODOWNMASTER.GODOWN_ID = STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_GODOWNID ", " AND BEAMMASTER.BEAM_NAME = '" & CMBBEAMFILTER.Text.Trim & "' AND STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_YEARID = " & YearId & " ORDER BY STOCKMASTER_BEAMGODOWN.SMBEAMGODOWN_NO")
                If dt.Rows.Count > 0 Then
