...
Public Class OpeningSaleOrder
    ...
    Sub getmax_OPSO_NO()
        ...
        If DTTABLE.Rows.Count > 0 Then TXTOPSONO.Text = DTTABLE.Rows(0).Item(0)
    End Sub
    ...
    Private Sub OpeningSaleOrder_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub fillcmb()
        Try
            ...
            fillname(CMBDELIVERYAT, edit, " and GROUPMASTER.GROUP_SECONDARY = 'Sundry Creditors' AND LEDGERS.ACC_TYPE = 'ACCOUNTS' AND LEDGERS.ACC_SUBTYPE = 'PROCESSOR'")
    ...
    Private Function errorvalid() As Boolean
        ...
        Else
            If PODATE.Text <> "__/__/____" Then
                If Convert.ToDateTime(OPSODATE.Text).Date < Convert.ToDateTime(PODATE.Text).Date Then
            ...
            If DELDATE.Text <> "__/__/____" Then
                If Convert.ToDateTime(OPSODATE.Text).Date > Convert.ToDateTime(DELDATE.Text).Date Then
    ...
    Private Sub OPSODATE_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles OPSODATE.GotFocus
        OPSODATE.SelectAll()
    End Sub

    Private Sub OPSODATE_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles OPSODATE.Validating
        Try
    ...
    Private Sub OpeningSaleOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If edit = True Then
                ...
                Dim DT As DataTable = OBJOPSO.SELECTOPSO()
                If DT.Rows.Count > 0 Then
                    For Each dr As DataRow In DT.Rows

                        TXTOPSONO.Text = dr("OPSONO")
                        OPSODATE.Text = Convert.ToDateTime(dr("DATE"))
                        ...
                        GRIDSO.Rows.Add(dr("GRIDSRNO").ToString, dr("QUALITY").ToString, Format(Val(dr("PCS")), "0"), Format(Val(dr("MTRS")), "0.00"), Format(Val(dr("RATE")), "0.00"), dr("PER"), Format(Val(dr("AMOUNT")), "0.00"), dr("DELIVERYAT"), dr("NARR").ToString, Val(dr("OUTPCS")), Val(dr("OUTMTRS")), dr("CLOSED"))
                    ...
                    Dim OBJCMN As New ClsCommon
                    DT = OBJCMN.search(" OPENINGSALEORDER_UPLOAD.OPSO_SRNO AS GRIDSRNO, OPENINGSALEORDER_UPLOAD.OPSO_REMARKS AS REMARKS, OPENINGSALEORDER_UPLOAD.OPSO_NAME AS NAME, OPENINGSALEORDER_UPLOAD.OPSO_PHOTO AS IMGPATH ", "", " OPENINGSALEORDER_UPLOAD ", " AND OPENINGSALEORDER_UPLOAD.OPSO_NO = " & TEMPOPSONO & " AND OPSO_YEARID = " & YearId & " ORDER BY OPENINGSALEORDER_UPLOAD.OPSO_SRNO")
                    If DT.Rows.Count > 0 Then
        ...
        Try
            ...
            For Each row As Windows.Forms.DataGridViewRow In gridupload.Rows
                ...
                If row.Cells(GUSRNO.Index).Value <> Nothing Then
                    ...
                    OBJOPSO.alParaval = ALPARAVAL
                    Dim INTRES As Integer = OBJOPSO.SAVEUPLOAD()
                End If
            Next
        ...
        Try
            ...
            If edit = False Then
                If USERADD = False Then
                    ...
                    Exit Sub
                End If
                Dim dttable As DataTable = OBJOPSO.SAVE()
                TEMPOPSONO = dttable.Rows(0).Item(0)
    ...
    Sub fillgrid()
        ...
        If GRIDDOUBLECLICK = False Then
            GRIDSO.Rows.Add(Val(txtsrno.Text.Trim), CMBQUALITY.Text.Trim, Format(Val(TXTPCS.Text.Trim), "0"), Format(Val(TXTMTRS.Text.Trim), "0.00"), Format(Val(TXTRATE.Text.Trim), "0.00"), CMBPER.Text.Trim, Format(Val(txtamount.Text.Trim), "0.00"), CMBDELIVERYAT.Text.Trim, TXTNARRATION.Text.Trim, 0, 0)
            getsrno(GRIDSO)
    ...
    Private Sub cmddelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        Try
            If edit = True Then
                ...
                If lbllocked.Visible = True Then
                    MsgBox("Unable to Delete, Opening S.O. Locked", MsgBoxStyle.Critical)
                    Exit Sub
                End If

                If MsgBox("Delete Opening Sale Order ?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    Dim alParaval As New ArrayList
                    alParaval.Add(TEMPOPSONO)
                    alParaval.Add(YearId)
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        Try
            ...
            Dim OBJSODTLS As New OpeningSaleOrderDetails
...
LINE1:
    ...
    Private Sub cmdclose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdclose.Click
        Try
            ...
            If MsgBox("Wish to Close Opening S.O.?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                If MsgBox("Are you Sure?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    ...
                    Dim intresult As Integer
                    Dim clsobjopso As New ClsOpeningSaleOrder
                    clsobjopso.alParaval = alParaval
                    intresult = clsobjopso.CLOSESO()
                    MsgBox("Opening S.O. Closed")
                    clear()
                End If
            End If
    ...
    Private Sub CMBDELIVERYAT_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMBDELIVERYAT.Enter
        Try
            If CMBDELIVERYAT.Text.Trim = "" Then fillname(CMBDELIVERYAT, edit, " and GROUPMASTER.GROUP_SECONDARY = 'Sundry Creditors' AND LEDGERS.ACC_TYPE = 'ACCOUNTS' AND LEDGERS.ACC_SUBTYPE = 'PROCESSOR'")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBDELIVERYAT_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBDELIVERYAT.Validating
        Try
            If CMBDELIVERYAT.Text.Trim <> "" Then namevalidate(CMBDELIVERYAT, cmbcode, e, Me, txtadd, " and GROUPMASTER.GROUP_SECONDARY = 'Sundry Creditors' AND LEDGERS.ACC_TYPE = 'ACCOUNTS' AND LEDGERS.ACC_SUBTYPE = 'PROCESSOR' ", "Sundy Creditors", "ACCOUNTS", "", "", "PROCESSOR")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
