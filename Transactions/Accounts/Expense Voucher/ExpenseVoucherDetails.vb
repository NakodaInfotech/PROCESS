...
Public Class ExpenseVoucherDetails
    ...
    Sub fillgrid(ByVal tepmcondition)
        Try
            ...
            Dim dt As DataTable = objclsCMST.search("  dbo.NONPURCHASE.NP_NO AS [Sr. No], dbo.NONPURCHASE.NP_DATE AS Date, dbo.LEDGERS.ACC_cmpname AS [Party Name], dbo.NONPURCHASE.NP_PARTYBILLNO AS [PartyBillNo], dbo.NONPURCHASE.NP_partybilldate AS [PartyBillDate], ISNULL(NP_RCM,0) AS RCM, NP_TOTALTAXABLEAMT AS TAXABLEAMT, NP_TOTALCGSTAMT AS CGSTAMT, NP_TOTALSGSTAMT AS SGSTAMT, NP_TOTALIGSTAMT AS IGSTAMT, dbo.NONPURCHASE.NP_GRANDTOTAL AS [Total Amt.], dbo.NONPURCHASE.NP_REMARKS AS [Remarks]  ", "", "  dbo.NONPURCHASE INNER JOIN dbo.LEDGERS ON dbo.NONPURCHASE.NP_LEDGERID = dbo.LEDGERS.ACC_id INNER JOIN REGISTERMASTER ON REGISTER_ID = NP_REGISTERID", tepmcondition)
    ...
    Private Sub cmbregister_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbregister.Validating
        Try
            ...
            If cmbregister.Text.Trim.Length > 0 Then
                ...
                Dim clscommon As New ClsCommon
                Dim dt As DataTable
                dt = clscommon.search(" register_id ", "", " RegisterMaster ", " and register_name ='" & cmbregister.Text.Trim & "' and register_type = 'EXPENSE' and register_yearid = " & YearId)
                If dt.Rows.Count > 0 Then
                    PURCHASEREGID = dt.Rows(0).Item(0)
                    fillgrid(" AND NONPURCHASE.NP_yearid = " & YearId & " AND NONPURCHASE.NP_registerid = " & PURCHASEREGID & " order by dbo.NONPURCHASE.NP_no ")
                Else
