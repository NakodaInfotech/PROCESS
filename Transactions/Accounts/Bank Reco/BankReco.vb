...
Public Class BankReco
    ...
    Sub TEMPBANKBAL()
        Try
            ...
            If DT.Rows.Count > 0 Then
                If DT.Rows(0).Item(4).ToString <> "" Then TXTTEMPBANKBAL.Text = Format(DT.Rows(0).Item(4), "0.00")
                LBLTEMPBANKDRCR.Text = DT.Rows(0).Item(5)
            End If
    ...
    Sub TOTAL()
        Try
            ...
            If LBLTEMPBANKDRCR.Text = "Dr" Then
                TXTTEMPBAL.Text = Format(Val(TXTTEMPBANKBAL.Text.Trim) + Val(TXTTOTALDR.Text.Trim) - Val(TXTTOTALCR.Text.Trim), "0.00")
            Else
                TXTTEMPBAL.Text = Format(Val(TXTTEMPBANKBAL.Text.Trim) + Val(TXTTOTALCR.Text.Trim) - Val(TXTTOTALDR.Text.Trim), "0.00")
            End If
    ...
    Private Sub EXCELUPLOAD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EXCELUPLOAD.Click
        ...
        If OBJUPLOAD.txtimgpath.Text.Trim <> "" Then
            ...
            CRAMTCOL = OBJUPLOAD.TXTCRAMTCOL.Text.Trim
            ...
            For I As Integer = STARTROW To ENDROW
                ...
                If IsDBNull(oSheet.Range(DRAMTCOL.ToString & I.ToString).Text) = False Then
                    If (oSheet.Range(DRAMTCOL.ToString & I.ToString).Text) <> "" Then
            ...
            If DT.Rows.Count > 0 Then
                For Each ROW As System.Data.DataRow In DT.Rows
                    For Each DTNEWROW As DataRow In DTNEW.Rows
                        If (DTNEWROW("Type") = "CONTRA" And DTNEWROW("BillDate") = ROW("DATE") And (Val(ROW("AMOUNT")) = Val(DTNEWROW("dr")) Or Val(ROW("AMOUNT")) = Val(DTNEWROW("cr")))) Or (ROW("CHQNO") = DTNEWROW("ChqNo") And (Val(ROW("AMOUNT")) = Val(DTNEWROW("dr")) Or Val(ROW("AMOUNT")) = Val(DTNEWROW("cr")))) Then
