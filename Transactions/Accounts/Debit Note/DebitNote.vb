...
ERRORMESSAGE:
    ...
    Async Sub SENDWHATSAPP(DNNO As Integer)
        Try
            ...
            OBJDN.PARTYNAME = CMBNAME.Text.Trim
            OBJDN.AGENTNAME = CMBAGENT.Text.Trim
            ...
            OBJWHATSAPP.FILENAME.Add(CMBNAME.Text.Trim & "DN_" & Val(DNNO) & ".pdf")
