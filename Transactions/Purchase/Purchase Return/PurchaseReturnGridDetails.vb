...
Public Class PurchaseReturnGridDetails
    ...
    Private Sub PurchaseReturnGridDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Sub fillgrid(ByVal tepmcondition)
        Try
            ...
            Dim dt As DataTable = OBJPUR.SELECTPR()
    ...
    Private Sub CMDOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            showform(True, gridbill.GetFocusedRowCellValue("RETNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub PurchaseReturnGridDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
