...
Public Class SelectPurScreen

    Dim USERADD, USEREDIT, USERVIEW, USERDELETE As Boolean      'USED FOR RIGHT MANAGEMAENT
    Public FRMSTRING As String = ""

    Private Sub SelectPurScreen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim OBJCMN As New ClsCommon
            Dim DT As DataTable = OBJCMN.search("REGISTER_NAME AS REGNAME, SCREENNAME AS FRMSTRING", "", "PURCHASEREGCONFIG INNER JOIN REGISTERMASTER ON REGISTER_ID = REGISTERID", " AND YEARID = " & YearId)
