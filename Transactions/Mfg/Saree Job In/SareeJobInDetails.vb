...
Public Class SareeJobInDetails
    ...
    Private Sub SareeJobInDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub SareeJobInDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal JOBINNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                MsgBox("Insufficient Rights")
                Exit Sub
            End If
            Dim OBJJO As New SareeJobIn
            OBJJO.EDIT = EDITVAL
            OBJJO.MdiParent = MDIMain
            OBJJO.TEMPJINO = JOBINNO
            OBJJO.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub fillgrid()
        Try
            ...
            OBJJO.alParaval.Add(0)
            OBJJO.alParaval.Add(YearId)
            Dim dttable As DataTable = OBJJO.SELECTJI()
    ...
    Private Sub CMDEDIT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMDEDIT.Click
        Try
            If USEREDIT = False Then
                ...
                Exit Sub
            End If
            showform(True, gridbill.GetFocusedRowCellValue("JINO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
