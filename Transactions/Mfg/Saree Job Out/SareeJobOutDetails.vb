...
Public Class SareeJobOutDetails
    ...
    Private Sub SareeJobOutDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub SareeJobOutDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal JOBOUTNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                MsgBox("Insufficient Rights")
                Exit Sub
    ...
    Private Sub CMDEDIT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMDEDIT.Click
        Try
            If USEREDIT = False Then
                ...
                Exit Sub
            End If
            showform(True, gridbill.GetFocusedRowCellValue("JONO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
