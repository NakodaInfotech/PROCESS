...
Public Class BeamIssue
    ...
    Private Sub BeamIssueToWeaver_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub BeamIssueToWeaver_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
...
Line2:
            If TEMPBEAMISSUENO > 0 Then
                ...
                If DT.Rows.Count > 0 Then
                    EDIT = True
                    BeamIssueToWeaver_Load(sender, e)
                Else
...
LINE1:
        ...
        Try
            ...
            If EDIT = True Then
                ...
                If TEMPMSG = vbYes Then
                    ...
                    Dim OBJDEL As New ClsBeamIssueToWeaver
    ...
    Async Sub SENDWHATSAPP(BEAMISSUEBEAMNO As Integer)
        Try
            ...
            Dim OBJCN As New BeamIssueDesign
