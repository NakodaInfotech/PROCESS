...
Public Class StoreConsumptionDetails
    ...
    Sub fillgrid()
        Try
            ...
            Dim DT As DataTable = OBJSTORE.SELECTCONSUMPTION
    ...
    Sub showform(ByVal editval As Boolean, ByVal CONSUMPTIONNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                ...
                OBJSTORES.TEMPCONSUMPTIONNO = CONSUMPTIONNO
                OBJSTORES.Show()
            End If
        Catch ex As Exception
            Throw ex
    ...
    Private Sub gridpayment_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gridbill.DoubleClick
        Try
            showform(True, gridbill.GetFocusedRowCellValue("CONSUMPTIONNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Stores Consumption Details.XLS"
            ...
            For Each proc In System.Diagnostics.Process.GetProcessesByName("Excel")
                proc.Kill()
            Next
            opti.SheetName = "Stores Consumption Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Stores Consumption Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
