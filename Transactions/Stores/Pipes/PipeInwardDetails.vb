...
Public Class PipeInwardDetails
    ...
    Private Sub PipeInwardDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub PipeInwardDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal INWARDNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJPIPE As New PipeInward
            OBJPIPE.EDIT = EDITVAL
            OBJPIPE.MdiParent = MDIMain
            OBJPIPE.TEMPINWARDNO = INWARDNO
            OBJPIPE.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub fillgrid()
        Try
            Dim OBJPIPE As New ClsPipeInward
            OBJPIPE.alParaval.Add(0)
            OBJPIPE.alParaval.Add(YearId)
            Dim dttable As DataTable = OBJPIPE.SELECTINWARD()
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            PATH = Application.StartupPath & "\Pipe Inward Details.XLS"
            ...
            opti.SheetName = "Pipe Inward Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Pipe Inward Details", gridbill.VisibleColumns.Count + gridbill.GroupCount, "", PERIOD)
