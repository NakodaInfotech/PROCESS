...
Public Class PipeOutwardDetails
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal OUTWARDNO As Integer)
        Try
            ...
            OBJPIPE.TEMPOUTWARDNO = OUTWARDNO
            OBJPIPE.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub fillgrid()
        Try
            Dim OBJPIPE As New ClsPipeOutward
            OBJPIPE.alParaval.Add(0)
            OBJPIPE.alParaval.Add(YearId)
            Dim dttable As DataTable = OBJPIPE.SELECTOUTWARD()
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            PATH = Application.StartupPath & "\Pipe Outward Details.XLS"
            ...
            opti.SheetName = "Pipe Outward Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Pipe Outward Details", gridbill.VisibleColumns.Count + gridbill.GroupCount, "", PERIOD)
