...
Public Class PipeOutward
    ...
    Sub getmax_BILL_no()
        Try
            Dim DTTABLE As DataTable = getmax(" isnull(max(PIPE_NO),0) + 1 ", "  PIPEOUTWARD ", " AND PIPE_YEARID = " & YearId)
    ...
    Private Sub PipeInward_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim OBJINWARD As New ClsPipeOutward
                Dim ALPARAVAL As New ArrayList
                ALPARAVAL.Add(TEMPOUTWARDNO)
                ALPARAVAL.Add(YearId)
                OBJINWARD.alParaval = ALPARAVAL
                Dim dttable As DataTable = OBJINWARD.SELECTOUTWARD()
    ...
    Private Function errorvalid() As Boolean
        Try
            ...
            If CHALLANDATE.Text <> "__/__/____" Then
                ...
                If Convert.ToDateTime(OUTWARDDATE.Text).Date < Convert.ToDateTime(CHALLANDATE.Text).Date Then
...
Line2:
            If TEMPOUTWARDNO > 0 Then
                ...
                Dim DT As DataTable = OBJCMN.search(" PIPE_NO ", "", "  PIPEOUTWARD ", " AND PIPE_NO = '" & TEMPOUTWARDNO & "' AND PIPEOUTWARD.PIPE_YEARID = " & YearId)
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJDTLS As New PipeOutwardDetails
        ...
        Try
            If EDIT = True Then
                ...
                If MsgBox("Delete Entry?", MsgBoxStyle.YesNo) = vbYes Then
                    ...
                    Dim ClsDO As New ClsPipeOutward
    ...
    Private Sub INWARDDATE_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles OUTWARDDATE.GotFocus
        OUTWARDDATE.SelectAll()
    End Sub

    Private Sub INWARDDATE_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles OUTWARDDATE.Validating
        Try
