...
Public Class BeamReturnFilter
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            Dim OBJBEAM As New BeamReturnDesign
            OBJBEAM.MdiParent = MDIMain
            OBJBEAM.WHERECLAUSE = " {BEAMRETURN.BEAMRETURN_YEARID}=" & YearId
            ...
            If CMBSIZER.Text.Trim <> "" Then OBJBEAM.WHERECLAUSE = OBJBEAM.WHERECLAUSE & " and {LEDGERS.ACC_CMPNAME}='" & CMBSIZER.Text.Trim & "'"

            If RDDETAILS.Checked = True Then
                OBJBEAM.FRMSTRING = "BEAMRETURN"
            ...
            ElseIf RDBSIZER.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJBEAM.FRMSTRING = "SIZERWISEDTLS" Else OBJBEAM.FRMSTRING = "SIZERWISESUMM"
