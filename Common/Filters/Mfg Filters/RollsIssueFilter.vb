...
Public Class RollsIssueFilter
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            ...
            OBJROLL.WHERECLAUSE = " {ROLLISSUE.ROLLISSUE_yearid}=" & YearId
            ...
            If CMBTRANSPORT.Text.Trim <> "" Then OBJROLL.WHERECLAUSE = OBJROLL.WHERECLAUSE & " and {TRANSLEDGERS.ACC_CMPNAME}='" & CMBTRANSPORT.Text.Trim & "'"
            ...
            If RDDETAILS.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJROLL.FRMSTRING = "ROLLSISSUEDTLS" Else OBJROLL.FRMSTRING = "ROLLSISSUESUMM"
            ...
            ElseIf RDBTRANS.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJROLL.FRMSTRING = "TRANSWISEDTLS" Else OBJROLL.FRMSTRING = "TRANSWISESUMM"
