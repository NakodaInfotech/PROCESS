...
Public Class GreyRecdFromWeaverFilter
    ...
    Private Sub GreyRecdFromWeaverFilter_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub GreyRecdFromWeaverFilter_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            fillcmb()
        Catch ex As Exception
            Throw ex
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            Dim OBJGREY As New GreyRecdFromWeaverDesign
            OBJGREY.MdiParent = MDIMain
            OBJGREY.WHERECLAUSE = " {GREYRECEIVEDWEAVER.GRECDWEAVER_yearid}=" & YearId
            ...
            If CMBWEAVER.Text.Trim <> "" Then OBJGREY.WHERECLAUSE = OBJGREY.WHERECLAUSE & " and {LEDGERS.ACC_CMPNAME}='" & CMBWEAVER.Text.Trim & "'"
            ...
            If CMBBEAMNAME.Text.Trim <> "" Then OBJGREY.WHERECLAUSE = OBJGREY.WHERECLAUSE & " and {BEAMMASTER.BEAM_NAME}='" & CMBBEAMNAME.Text.Trim & "'"

            If RDBBEAM.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJGREY.FRMSTRING = "BEAMWISE" Else OBJGREY.FRMSTRING = "BEAMWISESUMM"
            ElseIf RDBMONTHLY.Checked = True Then
                OBJGREY.FRMSTRING = "MONTHWISE"
            ElseIf RDBWEAVER.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJGREY.FRMSTRING = "WEAVERWISE" Else OBJGREY.FRMSTRING = "WEAVERWISESUMM"
            ElseIf RDBWEAVERQUALITY.Checked = True Then
                OBJGREY.FRMSTRING = "WEAVERQUALITYWISE"
            ElseIf RDBGREYQUALITY.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJGREY.FRMSTRING = "QUALITYWISE" Else OBJGREY.FRMSTRING = "QUALITYWISESUMM"
            End If
