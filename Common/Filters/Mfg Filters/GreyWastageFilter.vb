...
Public Class GreyWastageFilter
    ...
    Private Sub cmdshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            Dim OBJGREY As New GreyWastageDesign
            OBJGREY.MdiParent = MDIMain
            OBJGREY.WHERECLAUSE = " {GREYWASTAGE.GWASTAGE_YEARID}=" & YearId
            ...
            If RDDETAILS.Checked = True Then
                OBJGREY.FRMSTRING = "GREYWASTAGE"
            ElseIf RDBTYPE.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJGREY.FRMSTRING = "TYPEWISEDTLS" Else OBJGREY.FRMSTRING = "TYPEWISESUMM"
