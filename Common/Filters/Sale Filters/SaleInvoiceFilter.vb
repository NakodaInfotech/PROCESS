...
Public Class SaleInvoiceFilter
    ...
    Private Sub cmdshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdshow.Click
        Try
            ...
            If Val(TXTLOTNO.Text.Trim) > 0 Then OBJSALE.WHERECLAUSE = OBJSALE.WHERECLAUSE & " and {INVOICEMASTER_DESC.INVOICE_LOTNO}=" & Val(TXTLOTNO.Text.Trim)


            If RDBDETAILS.Checked = True Then
                OBJSALE.FRMSTRING = "SALEDTLS"
                If Val(TXTRATE.Text.Trim) > 0 Then OBJSALE.WHERECLAUSE = OBJSALE.WHERECLAUSE & " AND {INVOICEMASTER_DESC.INVOICE_RATE} = " & Val(TXTRATE.Text.Trim)
            ...
            ElseIf RDBGSTREGISTER.Checked = True Then
                If CHKSUMMARY.CheckState = CheckState.Unchecked Then OBJSALE.FRMSTRING = "GSTREGISTERDTLS" Else OBJSALE.FRMSTRING = "GSTREGISTERSUMM"

            ElseIf RDAVGSALEQUALITY.Checked = True Then
                OBJSALE.FRMSTRING = "AVGSALEQUALITYWISESUMM"

            ElseIf RDAVGSALEMONTHLY.Checked = True Then
                OBJSALE.FRMSTRING = "AVGSALEMONTHLY"
