    ...
    Private Sub cmdShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShowReport.Click
        Try
            ...
            Else
                ...
                'IF E1 FORM IS SELECTED THEN CALL THESE REPORTS
                If CMBFORM.Text.Trim = "E1 FORM" Then

                    Dim OBJE1FORM As New E1FormDesign
                    OBJE1FORM.MdiParent = MDIMain


                    Dim NAMECLAUSE As String = ""
                    If RBUNDERTRANSIT.Checked = True Then

                        If MsgBox("Print In Excel", MsgBoxStyle.YesNo) = MsgBoxResult.No Then

                            OBJE1FORM.STRSEARCH = " {E1TRANSITVIEW.YEARID} = " & YearId
                            If chkdate.Checked = True Then
                                getFromToDate()
                                OBJE1FORM.PERIOD = Format(dtfrom.Value, "dd/MM/yyyy") & " - " & Format(dtto.Value, "dd/MM/yyyy")
                                OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {@DATE} in date " & fromD & " to date " & toD & ""
                            Else
                                OBJE1FORM.PERIOD = Format(AccFrom, "dd/MM/yyyy") & " - " & Format(AccTo, "dd/MM/yyyy")
                            End If
                            ...
                            If NAMECLAUSE <> "" Then
                                ...
                                OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & NAMECLAUSE
                            End If
                            OBJE1FORM.FRMSTRING = "UNDERTRANSIT"
                            OBJE1FORM.Show()
                        Else
                            'PRINT IN EXCEL
                            ...
                            For i As Integer = 0 To gridbill.RowCount - 1
                                ...
                                If Convert.ToBoolean(dtrow("CHK")) = True Then
                                    If WHERECLAUSE = "" Then
                                        WHERECLAUSE = " AND (SUPPNAME = '" & dtrow("NAME") & "'"
                                    Else
                                        WHERECLAUSE = WHERECLAUSE & " OR SUPPNAME = '" & dtrow("NAME") & "'"
                                    End If
                                End If
                            Next
                            ...
                            Dim OBJRPT As New clsReportDesigner("E1 Under Transit", System.AppDomain.CurrentDomain.BaseDirectory & "E1 Under Transit.xlsx", 2)
                            If chkdate.CheckState = CheckState.Checked Then
                                OBJRPT.E1UNDERTRANSIT(dtfrom.Value.Date, dtto.Value.Date, CmpId, YearId, WHERECLAUSE)
                            Else
                                OBJRPT.E1UNDERTRANSIT(AccFrom, AccTo, CmpId, YearId, WHERECLAUSE)
                            End If
                        End If
                        Exit Sub
                    End If

                    OBJE1FORM.STRSEARCH = " {E1FORMVIEW.YEARID} = " & YearId
                    OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.FORMNAME} = '" & CMBFORM.Text.Trim & "'"

                    If CMBBROKER.Text.Trim <> "" Then OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.AGENT} = '" & CMBBROKER.Text.Trim & "'"
                    If RBREC.Checked = True Then OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.TYPE} = 'SALE'" Else OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.TYPE} = 'PURCHASE'"
                    ...
                    If CHKRECDDATE.Checked = True Then
                        getRECDFromToDate()
                        OBJE1FORM.PERIOD = Format(RECDFROM.Value, "dd/MM/yyyy") & " - " & Format(RECDTO.Value, "dd/MM/yyyy")
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {@RECDATE} in date " & fromD & " to date " & toD & ""
                    End If

                    If RBDETAILSPENDING.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.E1FORMNO} = '' and {E1FORMVIEW.CFORMNO} <> ''"
                        OBJE1FORM.FRMSTRING = "ALLBILLSPENDINGDTLS"
                        OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " PENDING - DETAILS"
                    ElseIf RBPENDING.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.E1FORMNO} = '' and {E1FORMVIEW.CFORMNO} <> ''"
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "PENDINGSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " PENDING - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "PENDINGDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " PENDING - DETAILS"
                        End If
                    ...
                    ElseIf RBRECEIVED.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.E1FORMNO} <> '' and {E1FORMVIEW.CFORMNO} <> ''"
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "RECDSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " RECEIVED - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "RECDDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " RECEIVED - DETAILS"
                        End If
                    ElseIf RBALL.Checked = True Then
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "ALLSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " ALL - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "ALLDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " ALL - DETAILS"
                        End If
                    ElseIf RBBROKERPENDING.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.E1FORMNO} = '' AND {E1FORMVIEW.AGENT} <> '' AND {E1FORMVIEW.CFORMNO} <> ''"
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "BROKERPENDINGSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE PENDING - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "BROKERPENDINGDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE PENDING - DETAILS"
                        End If
                    ElseIf RBBROKERRECD.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " and {E1FORMVIEW.E1FORMNO} <> '' AND {E1FORMVIEW.AGENT} <> ''"
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "BROKERRECDSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE RECEIVED - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "BROKERRECDDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE RECEIVED - DETAILS"
                        End If
                    ElseIf RBBROKERALL.Checked = True Then
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & " AND {E1FORMVIEW.AGENT} <> ''"
                        If CHKSUMMARY.CheckState = CheckState.Checked Then
                            OBJE1FORM.FRMSTRING = "BROKERALLSUMM"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE ALL - SUMMARY"
                        Else
                            OBJE1FORM.FRMSTRING = "BROKERALLDTLS"
                            OBJE1FORM.REPORTTITLE = CMBFORM.Text.Trim & " BROKER WISE ALL - DETAILS"
                        End If
                    ElseIf RBLETTER.Checked = True Then
                        If CMBFORM.Text.Trim = "" Then
                            ...
                            Exit Sub
                        End If
                        OBJE1FORM.FRMSTRING = "LETTER"
                        OBJE1FORM.PERIOD = CMBFORM.Text.Trim & " PENDING ANNEXURE FOR - " & OBJE1FORM.PERIOD
                        OBJE1FORM.FORMNO = CMBFORM.Text.Trim
                    ...
                    If NAMECLAUSE <> "" Then
                        ...
                        OBJE1FORM.STRSEARCH = OBJE1FORM.STRSEARCH & NAMECLAUSE
                    End If
                    If CHKGROUPONNEWPG.Checked = True Then OBJE1FORM.NEWPAGE = CHKGROUPONNEWPG.Checked
                    OBJE1FORM.Show()
