...
Public Class SendMail
    ...
    Private Sub SendMail_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            txtmailbody.Text = "Dear Sir / Madam," & vbCrLf & vbCrLf & "<b>Greetings from " & CmpName & "!!!</b>" & vbCrLf & vbCrLf & "Please find the attached document for your kind perusal." & vbCrLf & vbCrLf & "Do not hesitate to contact us for any further assistance " & vbCrLf & vbCrLf & "Thanks & Regards" & vbCrLf & UserName & vbCrLf & DT.Rows(0).Item("ADD1") & vbCrLf & DT.Rows(0).Item("ADD2") & vbCrLf & DT.Rows(0).Item("WEBSITE")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Sub fillcmb(ByRef cmb As System.Windows.Forms.ComboBox)
        Try
            If cmb.Text.Trim = "" Then
                ...
                Dim dt As DataTable
                dt = OBJCMN.search("email_id", "", "EmailMaster", " and email_cmpid = " & CmpId)
    ...
    Sub cmbvalidate(ByRef cmb As System.Windows.Forms.ComboBox)
        Try
            ...
            If cmb.Text.Trim <> "" Then
                Dim OBJCMN As New ClsCommonMaster
                Dim dt As DataTable
                dt = OBJCMN.search("Email_id", "", "EmailMaster", " and Email_id = '" & cmb.Text.Trim & "' and Email_cmpid = " & CmpId)
                If dt.Rows.Count = 0 Then
                    Dim tempmsg As Integer = MsgBox("Email Address not present, Add New?", MsgBoxStyle.YesNo, "PROCESS")
