...
Public Class SelectGodown
    ...
    Sub FILLGRID(ByVal WHERECLAUSE As String)
        Try
            ...
            Dim DT As DataTable = OBJCMN.search("  ISNULL(GODOWN_name, '') AS GODOWNNAME, GODOWN_ID AS ID", "", "  GODOWNMASTER", SEARCH & WHERECLAUSE & "  AND GODOWNMASTER.GODOWN_CMPID = " & CmpId & " AND GODOWNMASTER.GODOWN_YEARID = " & YearId & " order by GODOWNMASTER.GODOWN_name ")
