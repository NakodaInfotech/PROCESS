...
Public Class SareeJobOutReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SareeJobOutReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSareeJobOutReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SareeJobOutReport = New SareeJobOutReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
