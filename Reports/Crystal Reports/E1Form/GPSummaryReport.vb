...
Public Class GPSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.GPSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGPSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GPSummaryReport = New GPSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
