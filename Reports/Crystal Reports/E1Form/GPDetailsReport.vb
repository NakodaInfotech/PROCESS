...
Public Class GPDetailsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.GPDetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGPDetailsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GPDetailsReport = New GPDetailsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
