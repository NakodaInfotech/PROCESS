...
Public Class E1TransitReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.E1TransitReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedE1TransitReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As E1TransitReport = New E1TransitReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
