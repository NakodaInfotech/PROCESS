...
Public Class E1FormLetterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.E1FormLetterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedE1FormLetterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As E1FormLetterReport = New E1FormLetterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
