...
Public Class ChallanReport_Yarn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.ChallanReport_Yarn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChallanReport_Yarn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChallanReport_Yarn = New ChallanReport_Yarn()
        rpt.Site = Me.Site
        Return rpt
    End Function
