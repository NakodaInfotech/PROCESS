...
Public Class POMillWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.POMillWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOMillWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POMillWiseDetails = New POMillWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
