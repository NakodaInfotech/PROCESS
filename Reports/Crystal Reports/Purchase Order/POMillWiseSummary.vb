...
Public Class POMillWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.POMillWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOMillWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POMillWiseSummary = New POMillWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
