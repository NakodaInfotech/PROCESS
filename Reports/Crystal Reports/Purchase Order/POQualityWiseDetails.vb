...
Public Class POQualityWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "POQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.POQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOQualityWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POQualityWiseDetails = New POQualityWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
