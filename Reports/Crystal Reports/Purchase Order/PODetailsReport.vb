...
Public Class PODetailsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.PODetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPODetailsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PODetailsReport = New PODetailsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
