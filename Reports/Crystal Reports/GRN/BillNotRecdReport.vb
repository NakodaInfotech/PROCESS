...
Public Class BillNotRecdReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.BillNotRecdReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillNotRecdReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillNotRecdReport = New BillNotRecdReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
