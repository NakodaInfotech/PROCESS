...
Public Class GRNMillWiseDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.GRNMillWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNMillWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNMillWiseDetails = New GRNMillWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
