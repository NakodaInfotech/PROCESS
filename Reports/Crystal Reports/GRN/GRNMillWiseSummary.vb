...
Public Class GRNMillWiseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.GRNMillWiseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNMillWiseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNMillWiseSummary = New GRNMillWiseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
