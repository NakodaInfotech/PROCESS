...
Public Class SaleRetMonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SaleRetMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRetMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRetMonthly = New SaleRetMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
