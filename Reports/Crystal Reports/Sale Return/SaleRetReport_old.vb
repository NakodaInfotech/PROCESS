...
Public Class SaleRetReport_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SaleRetReport_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRetReport_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRetReport_old = New SaleRetReport_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
