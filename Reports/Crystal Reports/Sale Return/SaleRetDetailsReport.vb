...
Public Class SaleRetDetailsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleRetDetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SaleRetDetailsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRetDetailsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRetDetailsReport = New SaleRetDetailsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
