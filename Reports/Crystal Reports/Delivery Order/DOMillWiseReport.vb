...
Public Class DOMillWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.DOMillWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDOMillWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DOMillWiseReport = New DOMillWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
