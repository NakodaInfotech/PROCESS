...
Public Class DOPartyWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.DOPartyWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDOPartyWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DOPartyWiseReport = New DOPartyWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
