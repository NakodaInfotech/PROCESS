...
Public Class DORegisterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.DORegisterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDORegisterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DORegisterReport = New DORegisterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
