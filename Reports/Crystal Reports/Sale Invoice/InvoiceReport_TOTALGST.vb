...
Public Class InvoiceReport_TOTALGST
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvoiceReport_TOTALGST.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.InvoiceReport_TOTALGST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_TOTALGST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_TOTALGST = New InvoiceReport_TOTALGST()
        rpt.Site = Me.Site
        Return rpt
    End Function
