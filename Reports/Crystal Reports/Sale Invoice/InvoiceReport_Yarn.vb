...
Public Class InvoiceReport_Yarn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.InvoiceReport_Yarn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceReport_Yarn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceReport_Yarn = New InvoiceReport_Yarn()
        rpt.Site = Me.Site
        Return rpt
    End Function
