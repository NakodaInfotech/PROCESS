...
Public Class UnliftedStockSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "UnliftedStockSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.UnliftedStockSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUnliftedStockSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UnliftedStockSummary = New UnliftedStockSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
