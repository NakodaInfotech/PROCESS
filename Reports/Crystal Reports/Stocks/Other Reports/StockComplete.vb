...
Public Class StockComplete
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.StockComplete.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockComplete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockComplete = New StockComplete()
        rpt.Site = Me.Site
        Return rpt
    End Function
