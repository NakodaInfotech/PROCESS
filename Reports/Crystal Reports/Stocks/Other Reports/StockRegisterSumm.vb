...
Public Class StockRegisterSumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.StockRegisterSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockRegisterSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockRegisterSumm = New StockRegisterSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
