...
Public Class StockOnHandDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.StockOnHandDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockOnHandDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockOnHandDetails = New StockOnHandDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
