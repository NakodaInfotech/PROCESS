...
Public Class StockOnHandSumm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.StockOnHandSumm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockOnHandSumm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockOnHandSumm = New StockOnHandSumm()
        rpt.Site = Me.Site
        Return rpt
    End Function
