...
Public Class WarperAddaSummReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WarperAddaSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.WarperAddaSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWarperAddaSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WarperAddaSummReport = New WarperAddaSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
