...
Public Class YarnQualityMillSummReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "YarnQualityMillSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.YarnQualityMillSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnQualityMillSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnQualityMillSummReport = New YarnQualityMillSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
