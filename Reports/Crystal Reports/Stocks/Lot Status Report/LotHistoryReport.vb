...
Public Class LotHistoryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.LotHistoryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotHistoryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotHistoryReport = New LotHistoryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
