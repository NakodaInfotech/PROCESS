...
Public Class PendingLotReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.PendingLotReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPendingLotReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PendingLotReport = New PendingLotReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
