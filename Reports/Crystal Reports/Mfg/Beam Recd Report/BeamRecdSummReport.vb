...
Public Class BeamRecdSummReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.BeamRecdSummReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBeamRecdSummReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BeamRecdSummReport = New BeamRecdSummReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
