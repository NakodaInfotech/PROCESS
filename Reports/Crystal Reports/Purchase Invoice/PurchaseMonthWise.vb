...
Public Class PurchaseMonthWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.PurchaseMonthWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseMonthWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseMonthWise = New PurchaseMonthWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
