...
Public Class PurchaseMillWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseMillWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.PurchaseMillWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchaseMillWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseMillWiseDetails = New PurchaseMillWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
