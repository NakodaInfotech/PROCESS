...
Public Class SOPendingDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SOPendingDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOPendingDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOPendingDetails = New SOPendingDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
