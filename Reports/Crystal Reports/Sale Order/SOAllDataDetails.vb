...
Public Class SOAllDataDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SOAllDataDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOAllDataDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOAllDataDetails = New SOAllDataDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
