...
Public Class SOChallanDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SOChallanDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOChallanDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOChallanDetails = New SOChallanDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
