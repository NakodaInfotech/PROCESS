...
Public Class SOQualityWiseDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SOQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROCESS.SOQualityWiseDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOQualityWiseDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOQualityWiseDetails = New SOQualityWiseDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
