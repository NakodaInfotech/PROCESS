...
Public Class FormDesign
    ...
    Dim RPTCFORMBROKERPENDINGDTLS As New CFormBrokerPendingReport_Details
    Dim RPTCFORMBROKERPENDINGSUMM As New CFormBrokerPendingReport_Summary
    ...
    Private Sub crpo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles crpo.Load
        Try
            ...
            ElseIf FRMSTRING = "BROKERPENDINGDTLS" Then
                crTables = RPTCFORMBROKERPENDINGDTLS.Database.Tables
            ElseIf FRMSTRING = "BROKERPENDINGSUMM" Then
                crTables = RPTCFORMBROKERPENDINGSUMM.Database.Tables
            ...
            ElseIf FRMSTRING = "BROKERPENDINGDTLS" Then
                RPTCFORMBROKERPENDINGDTLS.DataDefinition.FormulaFields("REPORTTITLE").Text = "'" & REPORTTITLE & "'"
                RPTCFORMBROKERPENDINGDTLS.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
                RPTCFORMBROKERPENDINGDTLS.GroupFooterSection3.SectionFormat.EnableNewPageAfter = NEWPAGE
                crpo.ReportSource = RPTCFORMBROKERPENDINGDTLS
            ElseIf FRMSTRING = "BROKERPENDINGSUMM" Then
                RPTCFORMBROKERPENDINGSUMM.DataDefinition.FormulaFields("REPORTTITLE").Text = "'" & REPORTTITLE & "'"
                RPTCFORMBROKERPENDINGSUMM.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
                crpo.ReportSource = RPTCFORMBROKERPENDINGSUMM
            ElseIf FRMSTRING = "BROKERRECDDTLS" Then
    ...
    Sub Transfer()
        Try
            ...
            ElseIf FRMSTRING = "BROKERPENDINGDTLS" Then
                expo = RPTCFORMBROKERPENDINGDTLS.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTCFORMBROKERPENDINGDTLS.Export()
            ElseIf FRMSTRING = "BROKERPENDINGSUMM" Then
                expo = RPTCFORMBROKERPENDINGSUMM.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTCFORMBROKERPENDINGSUMM.Export()
            ElseIf FRMSTRING = "BROKERRECDDTLS" Then
